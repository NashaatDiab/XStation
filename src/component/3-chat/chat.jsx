...
const ChatIcon = () => {
  ...
  return (
    <div className="chat-container ">
      {isChatVisible && (
        <div className="chat-button  icon-message" style={{backgroundColor:"#8281a3" }}  onClick={toggleChatVisibility} />
      )}
        ...
        <div className="chat-popup">
          ...
          <div className="chat-body">
            <div className="messages ">
             ...
             <span className='p-3' style={{backgroundColor:"##e5e5e5" , borderRadius:"0 20px 0 10px"}}>How can i help you ?</span>
